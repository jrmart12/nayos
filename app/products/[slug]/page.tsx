...
export default async function ProductPage({ params }: ProductPageProps) {
    ...
    return (
        <>
            ...
            <main className="pt-24 relative min-h-screen" style={{ backgroundImage: 'url(/sand-beige.jpg)', backgroundSize: 'cover', backgroundAttachment: 'fixed' }}>
                {/* Breadcrumb */}
                    ...
                    <div className="container mx-auto px-4 max-w-6xl">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12 items-center mb-16">
                            ...
                            <div className="order-2 space-y-6">
                                ...
                                {/* Description */}
                                {product.description && (
                                    <div className="border-t-4 border-b-4 border-[#9B292C] py-6">
                                ...
                                {product.cuts && product.cuts.length > 0 ? (
                                    <div className="mb-4">
                                        <p className="text-gray-700 font-bold uppercase text-sm mb-2">Disponible en diferentes porciones</p>
                                        <p className="text-gray-600 text-sm">Selecciona la porción que prefieras abajo</p>
                                    </div>
                                ) : product.price ? (
                                    <div className="text-3xl md:text-4xl lg:text-5xl font-black text-[#9B292C]" style={{ fontFamily: 'Impact, Haettenschweiler, sans-serif' }}>
                                        L{product.price.toFixed(0)} {product.unit || ''}
                                    </div>
                                ) : null}

                                {product.origin && (
                                    <p className="text-gray-700 font-bold">
                                        <span className="text-[#9B292C]">Origen:</span> {product.origin}
                                    </p>
                                )}

                                {product.weight && (
                                    <p className="text-gray-700 font-bold">
                                        <span className="text-[#9B292C]">Peso disponible:</span> {product.weight}
                                    </p>
                                )}
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            {product.preparation && (
                                <div className="bg-white border-4 border-[#9B292C] rounded-2xl p-6 shadow-xl">
                                    <h3 className="text-2xl font-black text-[#9B292C] mb-4 uppercase" style={{ fontFamily: 'Impact, Haettenschweiler, sans-serif' }}>Preparación</h3>
